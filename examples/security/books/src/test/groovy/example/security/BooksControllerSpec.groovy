...
import example.security.books.BooksRepositoryService
...
import io.micronaut.security.jwt.TokenGenerator
...
class BooksControllerSpec extends Specification {
    ...
    protected String accessToken(String username, List<String> roles) {
        ...
        tokenGenerator.generateToken(new DefaultUserDetails(username, roles), 3600)
    }
}