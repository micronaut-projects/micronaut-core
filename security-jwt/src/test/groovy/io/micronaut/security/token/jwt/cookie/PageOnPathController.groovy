...
@Secured("isAnonymous()")
@Controller("/")
class PageOnPathController {

    @Produces(MediaType.TEXT_HTML)
    @Get("/path/to/page")
    String pageOnPath(@Nullable Principal principal) {
    ...
    private String html(boolean loggedIn, String username) {
        ...
        if( loggedIn ) {
            sb.append("<form action=\"/path/to/page/logout\" method=\"POST\">")
