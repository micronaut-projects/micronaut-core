...
@Internal
@Experimental
public final class TypeAnnotatedClassElement extends io.micronaut.inject.ast.TypeAnnotatedClassElement {

    /**
     * @param delegate               The wrapped class element
     * @param typeAnnotationMetadata The type-use annotation metadata
     */
    public TypeAnnotatedClassElement(ClassElement delegate, ElementAnnotationMetadata typeAnnotationMetadata) {
    ...
    public ElementAnnotationMetadata typeAnnotationMetadata() {
        return (ElementAnnotationMetadata) typeAnnotationMetadata;
    }
}
