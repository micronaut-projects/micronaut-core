...
public record DecoratorDef(
    ...
    public DecoratorDef {
        ...
        if (members == null) {
            ...
            // Values arrive from the Python processor as polyglot values; the model holds plain Java values.
            members = Collections.unmodifiableMap(PythonValues.toJava(members));
        }
        if (stereotypes == null) {
            stereotypes = List.of();
        } else {
