...
public final class PythonClassElement extends AbstractPythonClassElement {
    ...
    private final class PythonEnclosedElementsQuery extends EnclosedElementsQuery<ClassDef, ElementDef> {
        ...
        protected Element toAstElement(ElementDef nativeType, Class<?> elementType) {
            ...
            PythonClassElement declaringClassElement = PythonClassElement.this; // Default to the queried class
            if (currentDeclaringClass != null && currentDeclaringClass != getNativeClassType(PythonClassElement.this)) {
            ...
            if (nativeType instanceof FunctionDef functionDef) {
                return new PythonMethodElement(functionDef, environment, declaringClassElement, PythonClassElement.this, environment.metadataFactory());
            } else if (nativeType instanceof AttributeDef attributeDef) {
                return new PythonFieldElement(attributeDef, environment, declaringClassElement, PythonClassElement.this, environment.metadataFactory());
            }
