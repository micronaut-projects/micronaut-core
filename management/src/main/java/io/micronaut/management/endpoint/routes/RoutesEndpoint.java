...
public class RoutesEndpoint {
    ...
    public Object getRoutes() {
        Stream<UriRouteInfo<?, ?>> uriRoutes = router.uriRoutes()
            .sorted(Comparator.comparing((UriRouteInfo<?, ?> r) -> r.getRouteTemplate().isMicronaut() ? r.getUriMatchTemplate().toPathString() : r.getRouteTemplate().expression()).thenComparing(UriRouteInfo::getHttpMethodName));
