...
class RoutesEndpointSpec extends Specification {
    ...
    void "test routes endpoint"() {
        ...
        when:
        def response = rxClient.exchange("/routes", Map).blockFirst()
        ...
        result['{[/routes],method=[GET],produces=[application/json]}']['method'] == "org.reactivestreams.Publisher<java.lang.Object> io.micronaut.management.endpoint.routes.RoutesEndpoint.getRoutes()"
