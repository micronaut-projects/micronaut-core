...
class RoutesEndpointSpec extends Specification {
    ...
    void "test routes endpoint"() {
        ...
        result['{[/routes],method=[GET],produces=[application/json]}']['method'] == "reactor.core.publisher.Mono<java.lang.Object> io.micronaut.management.endpoint.routes.RoutesEndpoint.getRoutes()"
