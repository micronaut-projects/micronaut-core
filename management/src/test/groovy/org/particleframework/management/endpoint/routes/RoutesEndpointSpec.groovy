...
class RoutesEndpointSpec extends Specification {
    ...
    void "test routes endpoint"() {
        ...
        result['{[/test/generics],method=[PUT],produces=[application/json]}']['method'] == "java.util.Map<java.lang.String, java.lang.Integer> org.particleframework.management.endpoint.routes.RoutesEndpointSpec\$TestController.generics()"
