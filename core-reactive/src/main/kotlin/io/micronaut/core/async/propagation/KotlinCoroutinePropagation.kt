...
/**
 * Kotlin Coroutine propagation utils.
 *
...
class KotlinCoroutinePropagation private constructor() {
    ...
    companion object {
        ...
        fun addPropagatedContext(context: CoroutineContext, propagatedContext: PropagatedContext): CoroutineContext {
            return context.plus(MicronautPropagatedContext(propagatedContext))
        }
        ...
        fun updatePropagatedContext(context: CoroutineContext, propagatedContext: PropagatedContext): CoroutineContext {
            return addPropagatedContext(
                context.minusKey(MicronautPropagatedContext.Key),
                propagatedContext
            )
        }
