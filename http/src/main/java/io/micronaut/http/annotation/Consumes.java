 ...
 *
 * <p>Generally with controllers one can use the {@code consumes} attribute of the {@code Controller} annotation, however this annotation is more generic and applies
 * to any component</p>
 *
