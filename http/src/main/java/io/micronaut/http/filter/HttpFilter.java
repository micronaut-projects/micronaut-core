...
/**
 * <p>A interface for classes that can intercept and filter {@link io.micronaut.http.HttpRequest} instances and can either proceed with the request or return a modified result</p>
 *
 ...
 *
 * <p>To modify the request filters can either wrap it (using {@link io.micronaut.http.HttpRequestWrapper} or pass it along the chain as is</p>
 *
