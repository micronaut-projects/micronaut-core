 ...
 * {@link io.micronaut.http.body.AsyncRequestBody#form()}. Text fields convert like the path
 ...
 * handler returns:</p>
 * <pre>{@code
 * routes.asyncPOST("/profile", (request, pathVariables, body) -> body.form().thenCompose(form ->
