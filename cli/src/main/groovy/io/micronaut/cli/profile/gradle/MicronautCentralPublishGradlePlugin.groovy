 ...
 */
package io.micronaut.cli.profile.gradle
...
"""
    ...
    void apply(Project project) {
        ...
        if(bintrayUploadTask != null) {
            taskContainer.create(name:"publish${NameUtils.getClassName(defaultClassifier)}", dependsOn: bintrayUploadTask)
        }
        if(installTask == null) {
    ...
    protected String getDefaultReleaseRepo() {
        "https://repo.micronaut.io/micronaut/configurations-releases"
    }

    protected String getDefaultSnapshotRepo() {
        "https://repo.micronaut.io/micronaut/configurations-snapshots"
    }
