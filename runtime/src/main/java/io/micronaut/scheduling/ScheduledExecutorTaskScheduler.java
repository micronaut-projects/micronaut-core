...
public class ScheduledExecutorTaskScheduler implements TaskScheduler {
    ...
    public ScheduledFuture<?> schedule(String cron, Runnable command) {
        ...
        NextFireTime delaySupplier = buildCronDelaySupplier(cron);
    ...
    private NextFireTime buildCronDelaySupplier(String cron) {
        return new NextFireTime(CronExpression.create(cron));
    }
}
