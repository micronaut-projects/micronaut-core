...
public @interface CachePut {
     ...
     *     <li>For blocking return types when the value is <tt>true</tt> the method will return prior to cache writes occurring and errors will be logged via the {@link io.micronaut.cache.AsyncCacheErrorHandler}.</li>*
     ...
     *     <li>When the return type is a {@link java.util.concurrent.CompletableFuture} and the value is <tt>true</tt> the future will complete prior to any {@link CachePut} operations completing and the operations will be executing asynchronously with errors logged by {@link io.micronaut.cache.AsyncCacheErrorHandler}.</li>
     * </ul>
     *
     *
