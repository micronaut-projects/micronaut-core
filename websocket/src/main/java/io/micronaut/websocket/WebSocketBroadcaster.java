...
public interface WebSocketBroadcaster {
     ...
     * @param mediaType The media type of the message. Used to select an appropriate {@link io.micronaut.http.body.MessageBodyWriter} via the {@link io.micronaut.http.body.MessageBodyHandlerRegistry}.
