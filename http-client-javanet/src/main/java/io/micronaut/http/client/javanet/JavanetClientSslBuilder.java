...
public final class JavanetClientSslBuilder extends SslBuilder<SSLContext> {

    private static final Logger LOG = LoggerFactory.getLogger(JavanetClientSslBuilder.class);

    /**
     * @param resourceResolver The resource resolver
     */
    public JavanetClientSslBuilder(ResourceResolver resourceResolver) {
