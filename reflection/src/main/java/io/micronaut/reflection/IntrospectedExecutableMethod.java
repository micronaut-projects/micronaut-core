 ...
 */
@Experimental
public final class IntrospectedExecutableMethod<T, R> extends AbstractReflectionExecutable<T, R> {

    private final BeanMethod<T, R> beanMethod;
    private final Method method;

    /**
     * Creates an executable method over the bean method of an introspection.
     *
    ...
    /**
     * The bean method this executable method dispatches to.
     *
     * @return The bean method
     */
    public BeanMethod<T, R> getBeanMethod() {
        return beanMethod;
    }
