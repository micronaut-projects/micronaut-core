...
public final class PythonAsyncioStreams {
    ...
    public static PublisherIterator iterator(Value publisher, @Nullable PythonEventLoop eventLoop, Value callbacks) {
        ...
        return new PublisherIterator(Publishers.convertToPublisher(ConversionService.SHARED, source), eventLoop, callbacks);
    }
    ...
    public static final class PublisherIterator implements Subscriber<Object> {
        ...
        private PublisherIterator(Publisher<Object> publisher, @Nullable PythonEventLoop eventLoop, Value callbacks) {
