...
class MicronautPublisherIterator:
    ...
    def __init__(self, publisher, loop):
        ...
        self._java = _AsyncioStreams.iterator(publisher, self._micronaut_loop, self)
        self._waiter = None
...
class MicronautPublisherAwaitable:
    ...
    def __await__(self):
        return _AsyncioRuntime.awaitPublisher(self.publisher).__await__()

    def __repr__(self):
        return f"MicronautPublisherAwaitable({self.publisher!r})"


def __micronaut_publisher_awaitable(publisher):
    """Java entry point: the awaitable view of a publisher returned by a Java member."""
    return MicronautPublisherAwaitable(publisher)
...
def as_async_iterable(publisher):
    ...
    return MicronautPublisherIterator(publisher, _micronaut_stream_loop())
