...
public class JdkHttpClient extends AbstractJdkHttpClient implements HttpClient {
    ...
    public BlockingHttpClient toBlocking() {
        return new JdkBlockingHttpClient(loadBalancer, httpVersion, configuration, contextPath, mediaTypeCodecRegistry, requestBinderRegistry, clientId, conversionService, sslBuilder);
    }
