...
public interface ClassWriterOutputVisitor {
     ...
     * @since 4.2.0
     */
    default Optional<GeneratedSourceFile> visitGeneratedSourceFile(String packageName, String fileNameWithoutExtension, io.micronaut.inject.ast.Element... originatingElements) {
