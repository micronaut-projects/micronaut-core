...
/**
 * Support for the elvis operator. Example: {@code foo ?: bar}.
 */
public final class ElvisOperator extends TernaryExpression {
    public ElvisOperator(ExpressionNode condition, ExpressionNode falseExpr) {
        super(condition, condition, falseExpr);
    }
