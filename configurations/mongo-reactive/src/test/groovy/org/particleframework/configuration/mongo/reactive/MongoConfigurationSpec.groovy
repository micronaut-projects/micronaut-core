...
class MongoConfigurationSpec extends Specification {
    ...
    void "test configure #property pool setting"() {
        ...
        MongoConfiguration configuration = context.getBean(MongoConfiguration)
    ...
    void "test configure #property pool setting for named server"() {
        ...
        NamedMongoConfiguration configuration = context.getBean(NamedMongoConfiguration, Qualifiers.byName('myServer'))
        MongoClientSettings clientSettings = configuration.buildSettings()
