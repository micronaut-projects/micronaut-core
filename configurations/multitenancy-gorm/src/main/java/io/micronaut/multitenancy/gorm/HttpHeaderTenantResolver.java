...
import io.micronaut.multitenancy.tenantresolver.HttpHeaderTenantResolverConfigurationProperties;
...
public class HttpHeaderTenantResolver implements TenantResolver {
    ...
    protected final TenantResolver delegate = new TenantResolverAdapter(new io.micronaut.multitenancy.tenantresolver.HttpHeaderTenantResolver(new HttpHeaderTenantResolverConfigurationProperties()));
