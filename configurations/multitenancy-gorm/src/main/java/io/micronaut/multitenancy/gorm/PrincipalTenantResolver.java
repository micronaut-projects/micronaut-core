...
public class PrincipalTenantResolver implements TenantResolver {
    ...
    protected final TenantResolver delegate = new TenantResolverAdapter(new io.micronaut.multitenancy.tenantresolver.PrincipalTenantResolver());

    /**
     * Constructs a Principal Tenant Resolver.
     */
