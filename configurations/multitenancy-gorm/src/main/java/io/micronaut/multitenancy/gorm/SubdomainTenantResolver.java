...
public class SubdomainTenantResolver implements TenantResolver {
    ...
    protected final TenantResolver delegate = new TenantResolverAdapter(new io.micronaut.multitenancy.tenantresolver.SubdomainTenantResolver());

    /**
     * Constructs a Subdomain Tenant Resolver.
     */
