...
//                    String propertyName = NameUtils.getPropertyNameForSetter(groovyMethodElement.getSimpleName().toString());
//
...
//                    }
//                } else if (methodAnnotationMetadata.hasAnnotation(ConfigurationSetter.class)) {
...
//                            true
//                    )
//                } else if (methodAnnotationMetadata.hasAnnotation(ConfigurationGetter.class)) {
...
//                            getBeanWriter().visitConfigBuilderEnd()
//                        }
//                    } else if (fieldElement.hasAnnotation(ConfigurationSetter.class)) {
//                        getBeanWriter().visitFieldValue(
//                                fieldElement.declaringType,
//                                fieldElement,
//                                fieldElement.isReflectionRequired(concreteClassElement),
...
//                            concreteClassElement,
//                            declaringClass,
//                            groovyVisitorContext.getClassElement(Duration.class).get(),
//                            configurationPrefix + propertyName,
//                            null,
//                            null
//                    )
