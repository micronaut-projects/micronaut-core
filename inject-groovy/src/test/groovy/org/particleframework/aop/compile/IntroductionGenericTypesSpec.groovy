...
import org.particleframework.aop.introduction.*;
import org.particleframework.context.annotation.*;
import org.particleframework.aop.compile.*;
import java.net.*;
...
''')
        ...
        !beanDefinition.isAbstract()
        beanDefinition != null
        returnType(beanDefinition, "getPerson").type.name == 'org.particleframework.aop.compile.Person'
        returnType(beanDefinition, "getPeopleArray").type.name.contains('org.particleframework.aop.compile.Person')
        returnType(beanDefinition, "getPeopleMap").typeVariables['K'].type.name == 'org.particleframework.aop.compile.Person'
        returnType(beanDefinition, "getPeopleMap").typeVariables['V'].type == URL
        returnType(beanDefinition, "getPeopleSingle").typeVariables['T'].type== List
        returnType(beanDefinition, "getPeopleSingle").typeVariables['T'].typeVariables['E'].type.name == 'org.particleframework.aop.compile.Person'
        returnType(beanDefinition, "getPeople").type == List
        returnType(beanDefinition, "getPeople").asArgument().hasTypeVariables()
        returnType(beanDefinition, "getPeople").asArgument().typeVariables['E'].type.name == 'org.particleframework.aop.compile.Person'
        returnType(beanDefinition, "getPeopleArray").type.isArray()
        returnType(beanDefinition, "getPeopleListArray").type == List
        returnType(beanDefinition, "getPeopleListArray").typeVariables['E'].type.isArray()
