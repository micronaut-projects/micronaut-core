 ...
 * {@link io.micronaut.jakarta.inject.tck.Car Car} instance to {@link #testsFor testsFor(Car)}:
 *
 * <pre>
 * import junit.framework.Test;
...
class Tck {
    ...
    /**
     * Constructs a JUnit test suite for the given {@link io.micronaut.jakarta.inject.tck.Car} instance.
     *
     * @param car to test
     ...
     */
    static Test testsFor(io.micronaut.jakarta.inject.tck.Car car, boolean supportsStatic,
