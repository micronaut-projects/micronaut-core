...
class Tire extends io.micronaut.jakarta.inject.tck.accessories.RoundThing {
    ...
    @Inject @PackageScope static void supertypeStaticMethodInjection(FuelTank methodInjection) {
        ...
        if (io.micronaut.jakarta.inject.tck.accessories.SpareTire.hasBeenStaticFieldInjected()) {
            subtypeStaticFieldInjectedBeforeSupertypeStaticMethods = true
        }
        if (io.micronaut.jakarta.inject.tck.accessories.SpareTire.hasBeenStaticMethodInjected()) {
