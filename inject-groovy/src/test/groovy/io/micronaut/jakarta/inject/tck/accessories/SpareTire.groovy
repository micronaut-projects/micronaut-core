 ...
 */
package io.micronaut.jakarta.inject.tck.accessories

import groovy.transform.PackageScope

import jakarta.inject.Inject

class SpareTire extends io.micronaut.jakarta.inject.tck.Tire {

    @PackageScope io.micronaut.jakarta.inject.tck.FuelTank constructorInjection = NEVER_INJECTED
    @Inject protected io.micronaut.jakarta.inject.tck.FuelTank fieldInjection = NEVER_INJECTED
    @PackageScope io.micronaut.jakarta.inject.tck.FuelTank methodInjection = NEVER_INJECTED
    @Inject @PackageScope static io.micronaut.jakarta.inject.tck.FuelTank staticFieldInjection = NEVER_INJECTED
    @PackageScope static io.micronaut.jakarta.inject.tck.FuelTank staticMethodInjection = NEVER_INJECTED

    @Inject
    SpareTire(io.micronaut.jakarta.inject.tck.FuelTank forSupertype, io.micronaut.jakarta.inject.tck.FuelTank forSubtype) {
        super(forSupertype)
        this.constructorInjection = forSubtype
    }

    @Inject @PackageScope void subtypeMethodInjection(io.micronaut.jakarta.inject.tck.FuelTank methodInjection) {
    ...
    @Inject @PackageScope static void subtypeStaticMethodInjection(io.micronaut.jakarta.inject.tck.FuelTank methodInjection) {
