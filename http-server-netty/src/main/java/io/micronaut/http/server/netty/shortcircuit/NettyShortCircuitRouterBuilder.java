 ...
 */
@Internal
public final class NettyShortCircuitRouterBuilder<R> implements ShortCircuitRouterBuilder<R> {
    ...
    @NonNull
    public <M> NettyShortCircuitRouterBuilder<M> transform(@NonNull BiFunction<MatchRule, R, ExecutionLeaf<M>> transform) {
        ...
        return (NettyShortCircuitRouterBuilder<M>) this;
    }
