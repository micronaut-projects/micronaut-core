...
public class HttpRequestDecoder extends MessageToMessageDecoder<HttpRequest> implements Ordered {
    ...
    private final ApplicationTypedEventPublisher<HttpRequestReceivedEvent> httpRequestReceivedEventPublisher;
    ...
    public HttpRequestDecoder(EmbeddedServer embeddedServer, ConversionService<?> conversionService, HttpServerConfiguration configuration) {
        ...
        this.httpRequestReceivedEventPublisher = embeddedServer.getApplicationContext().findTypedEventPublisher(HttpRequestReceivedEvent.class).orElse(null);
    }
    ...
    protected void decode(ChannelHandlerContext ctx, HttpRequest msg, List<Object> out) {
        ...
        try {
            ...
            if (httpRequestReceivedEventPublisher != null) {
                try {
