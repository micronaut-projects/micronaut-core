...
final class ImmediateNettyInboundByteBody extends NettyInboundByteBody implements CloseableImmediateInboundByteBody {
    @Nullable
    private ByteBuf buffer;

    ImmediateNettyInboundByteBody(@NonNull ByteBuf buffer) {
