 ...
 */
public class TestColonRouteTemplateEngine implements RouteTemplateEngine {

    public static final String ID = "test.colon";

    private final String id;

    public TestColonRouteTemplateEngine() {
        this(ID);
    }

    protected TestColonRouteTemplateEngine(String id) {
        this.id = id;
    }
