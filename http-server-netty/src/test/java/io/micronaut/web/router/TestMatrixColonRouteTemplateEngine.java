 ...
 * each segment from a {@code ;} is removed from the path the routes match, while the request
 * keeps its raw URI.
 */
public class TestMatrixColonRouteTemplateEngine extends TestColonRouteTemplateEngine {

    public static final String ID = "test.colon.matrix";

    public TestMatrixColonRouteTemplateEngine() {
        super(ID);
    }
