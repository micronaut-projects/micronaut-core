...
class FiltersPropagatedContextSpec5 extends Specification {

    void "test filter context propagation"() {
        given:
            EmbeddedServer server = ApplicationContext.run(EmbeddedServer, ['spec.name': FiltersPropagatedContextSpec5.simpleName])
    ...
    @Requires(property = 'spec.name', value = 'FiltersPropagatedContextSpec5')
    @Client("/")
