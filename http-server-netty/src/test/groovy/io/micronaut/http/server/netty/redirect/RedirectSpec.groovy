...
class RedirectSpec extends Specification {
    ...
    @Shared @AutoCleanup ReactorHttpClient httpClient = embeddedServer.applicationContext.createBean(ReactorHttpClient, embeddedServer.getURL(), new DefaultHttpClientConfiguration(followRedirects: false))
