...
class FiltersPropagatedContextSpec11 extends Specification {

    void "test filter context propagation"() {
        given:
            EmbeddedServer server = ApplicationContext.run(EmbeddedServer, ['spec.name': FiltersPropagatedContextSpec11.simpleName])
    ...
    @Requires(property = 'spec.name', value = 'FiltersPropagatedContextSpec11')
    @Client("/")
