...
class FiltersPropagatedContextSpec2 extends Specification {

    void "test filter context propagation"() {
        given:
            EmbeddedServer server = ApplicationContext.run(EmbeddedServer, ['spec.name': FiltersPropagatedContextSpec2.simpleName])
    ...
    @Requires(property = 'spec.name', value = 'FiltersPropagatedContextSpec2')
    @Client("/")
