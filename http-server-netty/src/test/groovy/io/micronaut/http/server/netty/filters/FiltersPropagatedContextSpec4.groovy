...
class FiltersPropagatedContextSpec4 extends Specification {

    void "test filter context propagation"() {
        given:
            EmbeddedServer server = ApplicationContext.run(EmbeddedServer, ['spec.name': FiltersPropagatedContextSpec4.simpleName])
    ...
    @Requires(property = 'spec.name', value = 'FiltersPropagatedContextSpec4')
    @Client("/")
