...
public class TimeConverterRegistrar implements TypeConverterRegistrar {
    ...
    public void register(MutableConversionService conversionService) {
        ...
        addTemporalStringConverters(conversionService, YearMonth.class, IsoFormatter.ISO_YEAR_MONTH, YearMonth::from);
        addTemporalStringConverters(conversionService, Year.class, IsoFormatter.ISO_YEAR, Year::from);
        addTemporalIntegerConverters(conversionService, Year.class, IsoFormatter.ISO_YEAR, Year::from);
        addTemporalStringConverters(conversionService, MonthDay.class, IsoFormatter.ISO_MONTH_DAY, MonthDay::from);
