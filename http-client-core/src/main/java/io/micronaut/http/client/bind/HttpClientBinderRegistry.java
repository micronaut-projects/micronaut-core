...
public interface HttpClientBinderRegistry {
     ...
     */
    <T> Optional<ClientArgumentRequestBinder<?>> findArgumentBinder(Argument<T> argument);
     ...
     */
    Optional<AnnotatedClientRequestBinder<?>> findAnnotatedBinder(Class<?> annotationType);
}
