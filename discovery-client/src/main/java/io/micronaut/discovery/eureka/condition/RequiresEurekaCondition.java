...
public class RequiresEurekaCondition implements Condition {
    ...
    public boolean matches(ConditionContext context) {
        ...
        if (beanContext instanceof PropertyResolver) {
            ...
            return propertyResolver.getProperty("eureka.client.discovery.enabled", Boolean.class, Boolean.TRUE) ||
                    propertyResolver.getProperty("eureka.client.registration.enabled", Boolean.class, Boolean.TRUE);
        }
        return true;
    }
}
