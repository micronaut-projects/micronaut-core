...
public abstract class AbstractParametrizedBeanDefinition<T> extends AbstractBeanDefinition<T> implements ParametrizedBeanFactory<T> {
    ...
    protected AbstractParametrizedBeanDefinition(Annotation scope, boolean singleton, Class<T> type, Constructor<T> constructor, Argument[] arguments) {
        super(scope, singleton, type, constructor, arguments);
        this.requiredArguments = resolveRequiredArguments();
    }
