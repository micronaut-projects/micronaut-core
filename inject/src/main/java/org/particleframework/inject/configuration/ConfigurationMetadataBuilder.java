...
/**
 * <p>A builder for producing metadata for the available {@link org.particleframework.context.annotation.ConfigurationProperties}</p>
 * <p>
...
public abstract class ConfigurationMetadataBuilder<T> {
    ...
    /**
     * Visit a {@link org.particleframework.context.annotation.ConfigurationProperties} class
     *
     * @param type        The type of the {@link org.particleframework.context.annotation.ConfigurationProperties}
     ...
     * <p>
     * <p>For {@link org.particleframework.context.annotation.ConfigurationProperties} that path is a property is established by looking
     * at the value of the {@link org.particleframework.context.annotation.ConfigurationProperties} and then calculating the path based on the
     * inheritance tree.</p>
     * <p>
