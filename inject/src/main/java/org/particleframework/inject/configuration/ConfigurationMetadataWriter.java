...
/**
 * An interface for classes that write {@link org.particleframework.context.annotation.ConfigurationProperties} metadata
 *
...
public interface ConfigurationMetadataWriter {
     ...
     * @throws IOException If an error occurred writing outpu
     */
