...
class AnnotationMetadataSupport {
    ...
    private static int calculateHashCode(Map<String, Object> values) {
        int hashCode = 0;
    ...
    private static class AnnotationProxyHandler implements InvocationHandler {
        ...
        public AnnotationProxyHandler(int hashCode, Class<?> annotationClass, Map<CharSequence, Object> resolvedValues) {
