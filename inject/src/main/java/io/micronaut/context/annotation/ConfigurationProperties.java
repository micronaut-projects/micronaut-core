...
public @interface ConfigurationProperties {
     ...
     *
     * <p>For example given a prefix value {code server-} and a property called {code port}, Micronaut will attempt to resolve the value of --server-port when specified on the command line</p>
     *
