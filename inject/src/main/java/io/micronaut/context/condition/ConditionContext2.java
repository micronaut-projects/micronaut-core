...
public interface ConditionContext2<T extends AnnotationMetadataProvider> extends PropertyResolver {
     ...
     * @return The {@link ConditionContext2}
     */
    ConditionContext2<T> fail(@NonNull Failure failure);
     ...
     * @return The {@link ConditionContext2}
     */
    default ConditionContext2<T> fail(@NonNull String failure) {
