...
@FunctionalInterface
@Introspected
public interface EnvCondition extends Predicate<ConditionContext2> {
     ...
     */
    boolean matches(ConditionContext2 context);

    @Override
    default boolean test(ConditionContext2 condition) {
