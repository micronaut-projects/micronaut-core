 ...
 */
@Internal
class ReflectionMethodInjectionPoint implements MethodInjectionPoint {
    ...
    ReflectionMethodInjectionPoint(BeanDefinition declaringBean,
                                   Method method,
    ...
    ReflectionMethodInjectionPoint(BeanDefinition declaringComponent,
                                   Field field,
                                   Method method,
                                   boolean requiresReflection,
                                   Argument... arguments) {
