 ...
 * @since 1.0.0
 */
public class RequiresCondition2 implements EnvCondition {
     ...
     */
    public RequiresCondition2(AnnotationMetadata annotationMetadata) {
        this.annotationMetadata = annotationMetadata;
    }

    @Override
    public boolean matches(ConditionContext2 context) {
    ...
    private void processPreStartRequirements(ConditionContext2 context, AnnotationValue<Requires> requirements) {
...
//        }
    ...
    private boolean matchesProperty(ConditionContext2 context, AnnotationValue<Requires> requirements) {
    ...
    private boolean matchesMissingProperty(ConditionContext2 context, AnnotationValue<Requires> requirements) {
    ...
    private boolean matchesEnvironment(ConditionContext2 context, AnnotationValue<Requires> requirements) {
...
//    private boolean matchesCustomConditions(ConditionContext2 context, AnnotationValue<Requires> requirements) {
...
//    }
    ...
    private boolean matchesSdk(ConditionContext2 context, AnnotationValue<Requires> requirements) {
    ...
    private boolean matchesPresenceOfClasses(ConditionContext2 context, AnnotationValue<Requires> convertibleValues) {
        return matchesPresenceOfClasses(context, convertibleValues, MEMBER_CLASSES);
    }

    private boolean matchesAbsenceOfClasses(ConditionContext2 context, AnnotationValue<Requires> requirements) {
    ...
    private boolean matchAbsenceOfClassNames(ConditionContext2 context, AnnotationValue<Requires> requirements) {
        if (requirements.contains(MEMBER_MISSING_CLASSES)) {
            final String[] classNameArray = requirements.stringValues(MEMBER_MISSING_CLASSES);
            final ClassLoader classLoader = context.getEnvironment().getClassLoader();
    ...
    private boolean matchesPresenceOfClasses(ConditionContext2 context, AnnotationValue<Requires> requirements, String attr) {
    ...
    private boolean matchesPresenceOfEntities(ConditionContext2 context, AnnotationValue<Requires> annotationValue) {
    ...
    private boolean matchesPresenceOfResources(ConditionContext2 context, AnnotationValue<Requires> requirements) {
...
//                if (beanContext instanceof ApplicationContext) {
                ResourceLoader resourceLoader = context.getEnvironment();
...
//                }
    ...
    private boolean matchesCurrentOs(ConditionContext2 context, AnnotationValue<Requires> requirements) {
