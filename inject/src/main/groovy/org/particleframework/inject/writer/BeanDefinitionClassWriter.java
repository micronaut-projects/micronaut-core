...
public class BeanDefinitionClassWriter extends AbstractClassFileWriter {
    ...
    /**
     * Write the class to the output stream, such as one generated by a JavaFileObject genarted by a java annotation processor Filer object
     *
     * @param outputStream the utput stream poitning to tthe target class file
     */
