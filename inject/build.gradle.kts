...
noReflection {
    ...
    allowIn("io.micronaut.inject.annotation.AnnotationMetadataSupport", "ANNOTATIONS", "CLASS_LOADING", "PROXY")
    allowIn("io.micronaut.inject.annotation.DefaultAnnotationMetadata", "ENUM_CONSTANTS", "REFLECTIVE_ACCESS")
    allowIn("io.micronaut.inject.annotation.MappingAnnotationMetadataDelegate", "ANNOTATION_SYNTHESIS", "REFLECTIVE_ACCESS")
