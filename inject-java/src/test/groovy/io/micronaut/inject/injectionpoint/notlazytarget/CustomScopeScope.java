...
public class CustomScopeScope implements CustomScope<io.micronaut.inject.injectionpoint.notlazytarget.CustomScope> {
    @Override
    public Class<io.micronaut.inject.injectionpoint.notlazytarget.CustomScope> annotationType() {
        return io.micronaut.inject.injectionpoint.notlazytarget.CustomScope.class;
    }
