...
public class CustomScopeScope implements CustomScope<io.micronaut.inject.injectionpoint.cacheablelazytarget.CustomScope> {
    @Override
    public Class<io.micronaut.inject.injectionpoint.cacheablelazytarget.CustomScope> annotationType() {
        return io.micronaut.inject.injectionpoint.cacheablelazytarget.CustomScope.class;
    }
