...
/**
 * Asserts that annotation member defaults of every kind are reported for Java, identically to the other two
 ...
 */
class AnnotationMemberDefaultsSpec extends AbstractTypeElementSpec {
