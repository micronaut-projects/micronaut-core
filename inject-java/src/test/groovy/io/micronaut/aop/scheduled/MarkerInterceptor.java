...
public class MarkerInterceptor implements MethodInterceptor<Object, Object> {
    ...
    public final List<ScheduledInvocation> invocations = new ArrayList<>();
    ...
    public Object intercept(MethodInvocationContext<Object, Object> context) {
        ...
        records.add(context.getDeclaringType().getSimpleName() + "." + context.getMethodName() + ":" + (scheduled != null));
