...
import org.particleframework.annotation.processing.JavaConfigurationMetadataBuilder
...
''')
        ...
        def propertyMetadata = builder.visitProperty(element, builder.elements.getTypeElement("java.lang.String"), "setterTest", "some description", null)
...
''')
        ...
        builder.visitProperty(element, builder.elements.getTypeElement("java.lang.String"), "foo", "some description", null)
...
''')
        ...
        def builder = createBuilder()
        builder.visitProperties(element, "some description")
        builder.visitProperty(element, builder.elements.getTypeElement("java.lang.String"), "setterTest", "some description", null)
