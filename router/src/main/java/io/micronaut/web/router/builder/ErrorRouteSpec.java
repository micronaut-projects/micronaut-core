...
public sealed interface ErrorRouteSpec permits DefaultErrorRouteSpec {
     ...
     * {@code HttpResponse<R>} of an {@code @Error} method: the message body writer is selected
     ...
     * @since 5.3.0
     */
    ErrorRouteSpec responseType(Argument<?> responseType);
     ...
     * @since 5.3.0
     */
    default ErrorRouteSpec responseType(Class<?> responseType) {
