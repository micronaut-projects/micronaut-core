...
/**
 * The {@link StatusRouteSpec}: configures the status route and its handler, which hold the
 * configuration.
 *
 * @param route   The status route
 * @param handler The handler of the route
 * @author Denis Stepanov
 * @since 5.3.0
 */
@Internal
record DefaultStatusRouteSpec(RouteAssembly.DefaultStatusRoute route, HandlerMethod<?> handler) implements StatusRouteSpec {
