...
/**
 * An asynchronous filter of one route's responses that changes the propagated context, declared
 * with {@link HttpRouteSpec#afterAsync(AsyncContextRouteResponseFilter)}: the
 * {@link AsyncRouteResponseFilter} that receives a {@link MutablePropagatedContext}. The change is
 * taken when the returned stage completes.
 *
...
@Experimental
@FunctionalInterface
public interface AsyncContextRouteResponseFilter {
