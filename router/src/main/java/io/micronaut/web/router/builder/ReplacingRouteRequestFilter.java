...
/**
 * A filter of one route's requests, declared with {@link io.micronaut.web.router.builder.HttpRouteSpec#beforeReplacing(ReplacingRouteRequestFilter)}.
...
@Experimental
@FunctionalInterface
public interface ReplacingRouteRequestFilter {
