...
public class RSASignatureConfiguration extends AbstractSignatureConfiguration {
     ...
     */
    public RSASignatureConfiguration(JwtSignatureConfiguration config) {
        ...
        if (config.getPemPath() != null) {
            ...
            if (keyPair.isPresent()) {
                this.publicKey = (RSAPublicKey) keyPair.get().getPublic();
                this.privateKey = (RSAPrivateKey) keyPair.get().getPrivate();
            }
        }
    }
