...
public interface TokenRenderer {
    AccessRefreshToken render(String accessToken, String refreshToken);
    AccessRefreshToken render(AuthenticationSuccess authenticationSuccess, String accessToken, String refreshToken);
}
