...
from example.reflective import ClassRetainedMarker, ReflectiveColumn, ReflectiveMapping
...
class Book:
    ...
    id: Annotated[int | None, ReflectiveMapping(name="book_id"), ReflectiveColumn(value="id", length=10, precision=2, nullable=False)] = None
...
'''
    ...
    void "the Python state of the generated class is transient"() {
        ...
        def properties = ["title", "pages", "tags", "id"]
