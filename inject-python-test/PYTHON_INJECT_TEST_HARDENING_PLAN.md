...
* The latest pending ID is `PY-INJECT-0074`; use `PY-INJECT-0075` for the next
  pending case.
...
* The most recent focused verification passed for `MappedIntroductionSpec` with
  1 skipped pending test.
