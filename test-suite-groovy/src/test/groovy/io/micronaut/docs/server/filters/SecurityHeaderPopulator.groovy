...
// tag::clazz[]
@Singleton // <1>
class SecurityHeaderPopulator implements ResponseHeaderPopulator {
    @Override
    List<HttpHeaderEntry> findHttpHeaders(HttpRequest<?> request, HttpResponse<?> response) { // <2>
        [new HttpHeaderEntry('X-Content-Type-Options', 'nosniff')] // <3>
    }
}
// end::clazz[]
