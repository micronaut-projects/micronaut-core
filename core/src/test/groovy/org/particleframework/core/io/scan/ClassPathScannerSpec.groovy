...
import org.particleframework.core.io.scan.nested.Foo2
import org.particleframework.core.io.scan2.Foo3
...
class ClassPathScannerSpec extends Specification {
    ...
    void "test scan multiple packages"() {
        ...
        when:
        def classes = scanner.scan(AutoClone, getClass().getPackage().getName(), "org.particleframework.core.io.scan2")
        def results = classes.collect(Collectors.toList())
