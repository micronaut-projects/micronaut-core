...
module micronaut.core {
    ...
    exports io.micronaut.core.optim to micronaut.inject, micronaut.core.reactive;
    exports io.micronaut.core.util.clhm to micronaut.inject; //classes not marked as internal but i suspect they should be
}
