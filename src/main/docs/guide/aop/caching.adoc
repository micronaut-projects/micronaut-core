Similar to Spring and Grails, Micronaut provides a set of caching annotations within the link:{api}/org/particleframework/cache/package-summary.html[io.micronaut.cache] package.
