...
Unlike the aforementioned frameworks, Particle will use ASM to generate reflection free bytecode to optimize startup time and value injection performance.
