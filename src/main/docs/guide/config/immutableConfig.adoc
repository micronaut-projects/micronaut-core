Since 1.3, Micronaut framework supports the definition of immutable configuration. To enable mutable configuration, add the following dependency on Micronaut Context:
