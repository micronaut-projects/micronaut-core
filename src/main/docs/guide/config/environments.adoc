...
.Disabling nvironment detection
[source,bash]
----
...
.Using ApplicationContextBuilder
[source,groovy]
----
include::inject/src/test/groovy/io/micronaut/context/env/DefaultEnvironmentSpec.groovy[tag=disableEnvDeduction, indent=0]
----
