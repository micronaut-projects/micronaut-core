...
A convenience class api:core.io.ResourceResolver[] is provided that leverages these implementations. The following example illustrates using the API to read a text file from the classpath.
