api:views.model.security.SecurityViewsModelDecorator[] is enabled by default and injects the current username in the view. The following properties allow you to customize the injection:

include::{includedir}configurationProperties/io.micronaut.views.model.security.SecurityViewsModelDecoratorConfigurationProperties.adoc[]
