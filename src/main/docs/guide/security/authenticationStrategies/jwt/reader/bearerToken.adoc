...
The next configuration properties are available to customize Bearer Token read:
...
The next code snippet illustrates how to send a JWT token in the `Authorization` request header:
