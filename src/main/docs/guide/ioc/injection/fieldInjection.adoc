...
NOTE: In Scala, prefer constructor injection in normal application code. The Scala example in this section intentionally demonstrates field injection; other Scala examples use constructor, method, or test-parameter injection where possible.
