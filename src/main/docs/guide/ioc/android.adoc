...
[source.multi-language-sample,gradle-groovy,Example Android build.gradle]
----
dependencies {
    ...
...
[source.multi-language-sample,gradle-kotlin,Example Android build.gradle]
----
dependencies {
    ...
    annotationProcessor("io.micronaut:micronaut-inject-java:{version}")
...
[source.multi-language-sample,gradle-groovy,Configure lint within build.gradle]
----
...
[source.multi-language-sample,gradle-kotlin,Configure lint within build.gradle]
----
