...
|link:{api}/io/micronaut/runtime/context/scope/Request.html[@Request]
|`@Request` scope is a custom scope that indicates a new instance of the bean is created for each HTTP request
|===
