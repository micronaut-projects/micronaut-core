...
You can specify whether you want to initialize eagerly `@Singleton` scoped beans using the link:{api}/io/micronaut/context/scope/ApplicationContextBuilder.html[ApplicationContextBuilder] interface:
