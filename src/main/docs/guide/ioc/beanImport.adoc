...
NOTE: Bean import is currently only supported in the Java language as other
languages have limitations on classpath scanning during source code processing.
The Scala 3 compiler plugin does not support ann:context.annotation.Import[].
