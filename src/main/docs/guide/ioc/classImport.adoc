As an alternative to the ann:context.annotation.Import[] annotation the ann:context.annotation.ClassImport[] annotation allows processing already compiled classes as if they were ordinary non-compiled classes. Internally all the type visitors will be run, allowing to create necessary metadata.
