...
- Micronaut Maven Plugin `1.1.2` -> `1.1.4` 
- Micronaut XML `2.1.0` -> `2.2.1`
- Micronaut Data `2.2.1` -> `2.2.4`
- Micronaut Cache `2.2.0` -> `2.3.0`
- Micronaut Security `2.2.1` -> `2.3.0`
- Micronaut Spring `2.1.2` -> `3.2.0`
- Micronaut GCP `3.3.0` -> `3.4.0`
- Micronaut AWS `2.2.4` -> `2.3.0`
- Micronaut OpenAPI `2.2.1` -> `2.3.0`
- Micronaut SQL `3.3.4` -> `3.4.0`
...
- Micronaut Discovery Client `2.2.0` -> `2.2.2`
- Micronaut Kubernetes `2.1.0` -> `2.2.0`
- Micronaut JAX-RS `1.0.2` -> `2.0.0`
- Micronaut R2DBC `1.0.0.M2` -> `1.0.1`
