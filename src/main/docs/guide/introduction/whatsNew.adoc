...
The parent POM mentioned above supplies a new Micronaut Maven Plugin that enables automatic application restart during development. Just run the following:
