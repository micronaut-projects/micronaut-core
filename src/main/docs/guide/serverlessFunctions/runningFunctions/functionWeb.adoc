...
For further information on the use of `@FunctionClient`, please see <<callingFunctions, Calling Functions>>.
...
Create a link:{api}/io/micronaut/function/client/FunctionClient.html[FunctionClient] interface as shown below:
