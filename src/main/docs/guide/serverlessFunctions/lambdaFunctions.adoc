...
Configuration properties specific to AWS Lambda environments can be supplied in an `application-aws` configuration file.
...
include::{examples}/hello-world-lambda/build.gradle[tags=aws]
----
