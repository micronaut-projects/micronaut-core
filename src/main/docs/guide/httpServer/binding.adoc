...
You can customize the name of the variable bound with the link:{api}/io/micronaut/http/annotation/Parameter.html[@Parameter] annotation which accepts a value which is the name of the URI variable or request parameter to bind from.
...
|link:{api}/io/micronaut/http/annotation/Parameter.html[@Parameter]
