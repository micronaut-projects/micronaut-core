...
* A POJO. In this case, it will be decoded by default as JSON using the registered message body handlers. You can register a custom handler and define the content type of the handler using the ann:http.annotation.Consumes[] annotation.
