...
To run the application from a unit test you can use the link:{api}/org/particleframework/runtime/server/EmbeddedServer.html[EmbeddedServer] interface. The following test is written in Groovy with http://spockframework.org[Spock]:
