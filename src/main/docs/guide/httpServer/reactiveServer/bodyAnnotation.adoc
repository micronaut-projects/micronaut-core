To parse the request body, you first indicate to the Micronaut framework which parameter receives the data with the api:http.annotation.Body[] annotation.
