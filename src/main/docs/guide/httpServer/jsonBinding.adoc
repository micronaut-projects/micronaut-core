...
TIP: The deserialization done by Jackson can also be customized, e.g. via the `@JsonFormat` annotation to https://www.baeldung.com/jackson-serialize-dates#jsonformat[format dates] in individual ways.
