...
| propertyNamingStrategy | String | One of link:https://docs.micronaut.io/latest/api/io/micronaut/jackson/JacksonPropertyNamingStrategy.html[JacksonPropertyNamingStrategy]. Example: `SNAKE_CASE`
|=======
