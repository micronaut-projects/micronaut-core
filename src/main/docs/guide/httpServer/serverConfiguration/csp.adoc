...
An api:management.endpoint.annotation.Endpoint[endpoint] can be created to process violation report sent from user-agent. The following example demonstrates a simple CSP reporting endpoint:
