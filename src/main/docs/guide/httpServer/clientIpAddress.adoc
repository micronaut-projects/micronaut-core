You may need to resolve the originating IP address of an HTTP Request. Micronaut includes an implementation of api:http.server.util.HttpClientAddressResolver[].
