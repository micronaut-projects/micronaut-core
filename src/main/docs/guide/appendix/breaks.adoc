...
* link:{api}/io/micronaut/security/session/SessionSecurityfilterRejectionHandler.html[SessionSecurityfilterRejectionHandler] has been deprecated. link:{api}/io/micronaut/security/handlers/RedirectRejectionHandler.html[RedirectRejectionHandler] should be used instead.
