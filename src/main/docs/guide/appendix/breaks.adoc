...
* Token resolution api:io.micronaut.security.token.reader.TokenResolver[] has been extracted to its own bean from api:io.micronaut.security.token.TokenAuthenticationFetcher[]. See https://github.com/micronaut-projects/micronaut-core/issues/846[Issue 846]
