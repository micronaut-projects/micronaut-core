...
Micronaut by default will automatically perform Round Robin client-side load balancing using the servers in this list. This combined with <<retryAdvice, Retry Advice>> adds extra resiliency to your Microservice infrastructure.
