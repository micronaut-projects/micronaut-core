...
* ann:core.annotation.ReflectionConfig[] - A repeatable annotation that directly models the https://www.graalvm.org/latest/reference-manual/native-image/metadata/#reflection[reflection configuration in JSON format].
