...
[source,bash]
----
$ mn create-app hello-world --features graalvm
----
...
<1> The `-H:Name` argument specifies the name of the native image that will be generated.
...
----
$ ./mvnw package
$ native-image -cp target/hello-world-0.1-all.jar
----
