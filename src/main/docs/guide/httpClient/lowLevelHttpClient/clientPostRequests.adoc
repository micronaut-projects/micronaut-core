...
====
snippet::io.micronaut.docs.basics.HelloControllerSpec[tags="poststring", indent=0]
====
...
.Sending a JSON body
====
snippet::io.micronaut.docs.basics.HelloControllerSpec[tags="postpojo", indent=0]
====
