...
To resolve this, register an api:http.body.MessageBodyReader[] or api:http.body.MessageBodyWriter[] bean for the media type. The reader/writer will be automatically picked up and used to decode (or encode) messages.
