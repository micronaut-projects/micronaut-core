...
[source,kotlin]
----
@setparam:Client("\${myapp.api.twitter.url}") @Inject lateinit var httpClient: RxHttpClient
----
...
[source,java]
----
include::{testsclient}/basics/HelloControllerTest.java[tags=simple, indent=0]
----
...
[source,java]
----
include::{testsclient}/basics/HelloController.java[tags=imports, indent=0]

include::{testsclient}/basics/HelloController.java[tags=nonblocking, indent=0]
----
...
[source,java]
----
include::{testsclient}/basics/HelloController.java[tags=json, indent=0]
----
...
[source,java]
----
include::{testsclient}/basics/Message.java[tags=imports, indent=0]

include::{testsclient}/basics/Message.java[tags=class, indent=0]
----
...
[source,java]
----
include::{testsclient}/basics/HelloControllerTest.java[tags=jsonmap, indent=0]
----
...
[source,java]
----
include::{testsclient}/basics/HelloControllerTest.java[tags=jsonmaptypes, indent=0]
----
...
[source,java]
----
include::{testsclient}/basics/HelloControllerTest.java[tags=jsonpojo, indent=0]
----
...
[source,java]
----
include::{testsclient}/basics/HelloControllerTest.java[tags=pojoresponse, indent=0]
----
