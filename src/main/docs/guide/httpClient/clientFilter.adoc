Often, you need to include the same HTTP headers or URL parameters in a set of requests against a particle third-party API or
other particle micro-service. To simplify this, Particle includes a feature named `HttpClientFilter`.

The next example illustrates a Particle's bean which interacts with https://bintray.com/docs/api/[Bintray REST Api].
