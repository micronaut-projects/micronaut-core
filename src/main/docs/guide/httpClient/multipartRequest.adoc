...
<2> Method to add a part to the body, in this case a file. There are different variations of this method which you can see in api:http.client.multipart.MultipartBody[].
