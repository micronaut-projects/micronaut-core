...
The link:{api}/io/micronaut/core/convert/format/Format.html[Format] annotation can be used together with `@QueryValue` annotation to format query values. More information is given in the HTTP Server section, Simple Request Binding subsection.
