...
To create an app with Kotlin support (which comes with Kotest by default), supply the appropriate language via the `lang` flag:
...
This will include the Kotlin & Kotest dependencies in your project, and write the appropriates values in `micronaut-cli.yml`.
