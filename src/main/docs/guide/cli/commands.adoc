...
[source,bash]
----
$ mn create-command my-command
| Rendered template Command.java to destination src/main/java/java/app/MyCommand.java
| Rendered template CommandTest.java to destination src/test/java/java/app/MyCommandTest.java
----
