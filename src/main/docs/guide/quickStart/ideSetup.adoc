...
As of this writing, Eclipse has https://github.com/eclipse/eclipse.jdt.core/blob/8df02ebc7fde26fb9a3e7f4ba4730fef2349f133/org.eclipse.jdt.apt.pluggable.core/src/org/eclipse/jdt/internal/apt/pluggable/core/filer/IdeFilerImpl.java#L65[incomplete support] for Java annotation processors, hence you will have to delegate to BuildShip or M2Eclipse for building and running tests.
