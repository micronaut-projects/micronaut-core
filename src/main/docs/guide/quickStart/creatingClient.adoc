...
<1> The api:runtime.server.EmbeddedServer[] is injected into the test constructor
<2> A api:http.client.HttpClient[] instance is injected into the test constructor
