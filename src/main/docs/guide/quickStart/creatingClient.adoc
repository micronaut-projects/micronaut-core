...
[source,groovy]
----
include::{testsuite}/server/intro/javacode/HelloControllerSpec.groovy[tags=imports, indent=0]
include::{testsuite}/server/intro/javacode/HelloControllerSpec.groovy[tags=class-init, indent=0]
include::{testsuite}/server/intro/javacode/HelloControllerSpec.groovy[tags=embededdedServer, indent=0]
include::{testsuite}/server/intro/javacode/HelloControllerSpec.groovy[tags=class-end, indent=0]
----
...
[source,groovy]
----
include::{testsuite}/server/intro/javacode/HelloClientSpec.groovy[tags=class-init, indent=0]

include::{testsuite}/server/intro/javacode/HelloClientSpec.groovy[tags=embeddedServer, indent=0]

include::{testsuite}/server/intro/javacode/HelloClientSpec.groovy[tags=class-end, indent=0]
----
