...
- `activeKeys` defaults to ["activeEnvironments", "packages", "propertySources"]

The `activeKeys` property allows you to customize which sections of the environment information are displayed.
