...
A common requirement for supporting Multi-Tenancy is the ability to resolve the current tenant. Micronaut ships with the following built-in api:multitenancy.tenantresolver.TenantResolver[] implementations:
