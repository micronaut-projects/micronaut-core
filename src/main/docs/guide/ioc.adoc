...
If you are creating custom compile-time annotations or annotation mappers, see <<annotationMetadata, Annotation Metadata>> for additional requirements around `AnnotationMapper`, `NamedAnnotationMapper`, and `TypedAnnotationMapper`.
